...
public class SentToolTests {
    ...
    // TODO: Add your own unit tests here, or improve the above!
    // It is typical to group assertions in single functions that test
    // specific edge cases, and can be named accordingly
